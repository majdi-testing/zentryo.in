    ...
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-[#9fb3c8] max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-2xl mx-auto">
          {sent ? (
            <div className="bg-[#ffffff]/10 backdrop-blur rounded-2xl p-12 text-center border border-[#ffffff]/10">
              ...
              <p className="text-[#9fb3c8]">Thank you for reaching out. We&apos;ll get back to you shortly.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="bg-[#ffffff]/10 backdrop-blur rounded-2xl p-8 border border-[#ffffff]/10 space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 text-sm rounded-xl border border-[#ffffff]/20 bg-[#ffffff]/5 text-[#ffffff] placeholder-steel-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-cyan-500/60 backdrop-blur transition-all"
                  />
                </div>
                <div className="relative">
              ...
              <div className="relative">
                <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#829ab1]" />
                <input
              ...
              <div className="relative">
                <HelpCircle className="absolute left-3.5 top-3.5 h-4 w-4 text-[#829ab1]" />
                <textarea
                  required
                  rows={4}
                  ...
                  className="w-full pl-10 pr-4 py-3 text-sm rounded-xl border border-[#ffffff]/20 bg-[#ffffff]/5 text-[#ffffff] placeholder-steel-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-cyan-500/60 backdrop-blur transition-all resize-none"
                />
              </div>
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-cyan-500 hover:bg-cyan-600 text-[#ffffff] text-sm font-semibold rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-60 shadow-lg shadow-cyan-500/25"
              >
